...
// Policy for untrusted, user-authored HTML. It keeps the formatting Redash content relies on - links, lists,
// tables, emphasis, headings, images - and removes everything that can execute script or hijack the page.
//
...
// `viz-lib/src/services/sanitize.ts` configures the same DOMPurify instance and must be kept in sync.
...
/**
 * Sanitizes untrusted HTML before it is injected into the DOM, using `SANITIZE_CONFIG` above.
 */
